...
queue.Dequeue(); // 12
queue.Enqueue(13); // 13
queue.Enqueue(14); // 13, 14
queue.Enqueue(15); // 13, 14, 15
queue.Enqueue(16); // 13, 14, 15, 16
queue.Dequeue(); // 
queue.Dequeue(); // 15, 16
queue.Dequeue(); // 16
queue.Enqueue(17); // 16, 17
queue.Enqueue(18); // 16, 17, 18
queue.Dequeue(); // 17, 18
queue.Enqueue(19); // 17, 18, 19
queue.Enqueue(20); // 17, 18, 19, 20
